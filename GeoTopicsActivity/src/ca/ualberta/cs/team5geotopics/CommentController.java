...
public class CommentController {
	...
	public void newReply(CommentModel newComment, CommentModel parentComment, Context context) {
		parentComment.addReply(newComment);
		myUser.addToMyComments(newComment, context);
	}
	
	public void updateComment(CommentModel comment, String title, String author, String body){
