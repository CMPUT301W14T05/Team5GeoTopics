...
public class BrowseReplyActivity extends Activity
{
	...
	/*Right now this is almost an exact copy of Browse activity, meaning it uses the same xml and menus. 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CommentModel TLComment = (CommentModel) b.getSerializable("TLComment");
		this.clm.add(TLComment);
		this.clm.add(TLComment.getReplies().get(0)); //this is just the first reply. I know it exist since I added it to all replies in BrowseActivity
	...
	protected void onResume(){
		browseListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> myView, View view, int position,
					long arg3) {
				Intent intent = new Intent(BrowseReplyActivity.this, BrowseReplyActivity.class);
